...
#
# failure_message = SMTP::Message.new()
# failure_message.from = SMTP::Address.new(email="info@perspectiva.do", name="PT")
# failure_message.to << SMTP::Address.new(email="raynerdls@gmail.com", name="Rayner De Los Santos")
# failure_message.subject = "Prueba de notificacion de error"
...
#   </head>
#   <body>Prueba de envio correo <h1><strong>html</strong></h1></body>
#   </html>
# }
#
# client.send failure_message
